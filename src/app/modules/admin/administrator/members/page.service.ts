...
export class Service {
    ...
    uploadFile(item: FormData): Observable<any> {
        return this._httpClient
            .post<any>(environment.API_URL + 'api/import_member', item, this.httpOptionsFormdata)
    ...
    getList(): Observable<any[]> {
        return this._httpClient.get<any[]>(environment.API_URL + 'api/get_member').pipe(
            tap((meterial) => {
    ...
    updateMember(id: number, data: any) {
        return this._httpClient.put(environment.API_URL + 'api/member/' + id, data);
    }

    createMember(data: any) {
        return this._httpClient.post(environment.API_URL + 'api/member', data);
    }

    deleteMember(id: number) {
        return this._httpClient.delete(environment.API_URL + 'api/member/' + id);
    }
}
